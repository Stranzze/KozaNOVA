...
| Çoklu dil sistemi | *"Türkçe ve İngilizce destekleyen bir çeviri sistemi geliştir. Dil geçişi localStorage'da saklansın ve sayfa yeniden yüklenmeden çalışsın."* | `translations.js` ile 100+ metin anahtarı, anlık dil değiştirme ve kalıcı tercih desteği eklendi |
